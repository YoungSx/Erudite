...
<nav class="cd-side-navigation">
  <ul>
    ...
    <li> <a href="#0" class="selected" data-menu="projects"> <svg class="nc-icon outline" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
      <g transform="translate(0, 0)">
...
<main class="cd-main">
  <section class="cd-section projects visible">
    <header>
        ...
        <div class="slogan">åé å±äºä½ çç¥è¯</div>
        <div class="login">
          <form id="loginForm">
            <input class="username" id="username" placeholder="ç¨æ·å" type="text"><br>
            <input class="password" id="password" placeholder="å¯ç " type="password"><br>
            <a class="btnLogin" id="btnLogin">ç»é</a>
            <a class="btnRegister" id="btnRegister">æ³¨å</a>
          </form>
        </div>
 </header>
    <!-- .cd-content --> 
