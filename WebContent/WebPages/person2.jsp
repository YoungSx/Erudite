...
<<div class="cd-side-navigation">
  <ul>
    ...
    <li> <a href="view.jsp"> <svg class="nc-icon outline" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
      <g transform="translate(0, 0)">
    ...
    <li> <a class="selected" href="person.jsp"> <svg class="nc-icon outline" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
      <g transform="translate(0, 0)">
...
<main class="cd-main">
  ...
  <section class="cd-section person visible">
    <header>
        ...
        <div><img  class="userImage" src="sources/images/userImage.png"> </div>
        <div class="username">用户名</div>
        <div class="cancellationForm">
          <form id="cancellationForm">
            <a class="btnCancellation" id="btnCancellation">注销</a>
...
<script src="sources/script/personperson/login.js"></script>
