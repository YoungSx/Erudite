...
<nav class="cd-side-navigation">
  <ul>
    ...
    <li> <a class="selected" href="#0" data-menu="services"> <svg class="nc-icon outline" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
      <g transform="translate(0, 0)">
...
<main class="cd-main">
  <section class="cd-section services visible">
    <header>
      ...
      <a href="#services-content" class="cd-scroll">Scroll Down</a> </header>
