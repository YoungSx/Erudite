...
<body style="background-color: #A469CA">
<div class="cd-side-navigation">
  <ul>
    ...
    <li> <a class="selected" href="search.jsp"> <svg class="nc-icon outline" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
      <g transform="translate(0, 0)">
...
<script src="sources/script/search/searchresult.js"></script>
</body>
</html>
